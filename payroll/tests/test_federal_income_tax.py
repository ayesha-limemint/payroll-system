...
class FederalIncomeTaxTest(TestCase):
    ...
    def test_single_weekly_standard(self):
        ...
        self.assertEqual(result, Decimal("78.08"))
    ...
    def test_single_in_22pct_bracket(self):
        ...
        self.assertEqual(result, Decimal("270.19"))
    ...
    def test_mfj_biweekly(self):
        ...
        self.assertEqual(result, Decimal("192.31"))
    ...
    def test_single_top_bracket(self):
        ...
        self.assertEqual(result, Decimal("9479.18"))
    ...
    def test_frequency_consistency(self):
        ...
        for v in values:
            self.assertAlmostEqual(v, values[0], delta=Decimal("1.00"))
    ...
    def test_2025_schedule_differs_from_2026(self):
        ...
        self.assertEqual(y2026, Decimal("78.08"))
        self.assertEqual(y2025, Decimal("80.80"))
